class User < ApplicationRecord
  ...
  before_validation :set_terms_agreement
 ...
 def self.ransackable_attributes(auth_object = nil)
  ...
  validate :agreed_to_terms_of_use
  ...
  def set_terms_agreement
    if agreed_to_terms_of_use == false
      errors.add(:agreed_to_terms_of_use, "must be accepted")
    end
  end
